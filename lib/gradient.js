...
(function() {
  ...
  Gradient = (function() {
    ...
    function Gradient() {
      this.max = 255;
      this.buffer = new ArrayBuffer(255);
    ...
    Gradient.prototype.build = function() {
      var entries, entry1, entry2, i, intensity1, intensity2, invRange, j, level1, level2, range, value, _results;
      ...
      while (i--) {
        ...
        _results.push((function() {
          ...
          for (j = _i = range; range <= 0 ? _i <= 0 : _i >= 0; j = range <= 0 ? ++_i : --_i) {
            ...
            _results1.push(this.gradient[level1 + range] = ~~value);
          }
          return _results1;
        }).call(this));
      }
