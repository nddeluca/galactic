...
(function() {
  ...
  PSFConvolutor = (function() {
    ...
    PSFConvolutor.prototype.convolute = function() {
      var columns, iCol, iColM, iModelData, iPsfData, iRow, iRowM, ldnCol, ldnRow, modelData, modelLength, n, norm, paddedLength, padder, rCol, rColM, rModelData, rPsfData, rRow, rRowM, rows;
      rows = this.rows;
      columns = this.columns;
      ldnRow = this.ldnRow;
      ldnCol = this.ldnColumn;
