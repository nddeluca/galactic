...
(function() {
  ...
  PSFConvolutor = (function() {
    ...
    PSFConvolutor.prototype.convolute = function() {
      var a, b, c, columns, d, half_col, half_row, iCol, iColM, iModelData, iPsfData, iRow, iRowM, l, ldnCol, ldnRow, modelData, modelLength, n, norm, paddedLength, padder, r, rCol, rColM, rModelData, rPsfData, rRow, rRowM, rows, tmp13, tmp24, x, y;
      rows = this.rows;
      columns = this.columns;
      ldnRow = this.ldnRow;
      ldnCol = this.ldnColumn;
