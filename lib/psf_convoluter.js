...
(function() {
  ...
  PSFConvolutor = (function() {
    ...
    function PSFConvolutor(args) {
      ...
      this.rows = this.modelPadder.paddedHeight;
      this.columns = this.modelPadder.paddedWidth;
      ...
      this.rRowModel = new RowManipulator(this.modelPadder.paddedImage);
      this.iRowModel = new RowManipulator(this.iModelImage);
      this.rRowPsf = new RowManipulator(this.psfPadder.paddedImage);
      this.iRowPsf = new RowManipulator(this.iPsfImage);
      this.rColModel = new ColumnManipulator(this.modelPadder.paddedImage);
      this.iColModel = new ColumnManipulator(this.iModelImage);
      this.rColPsf = new ColumnManipulator(this.psfPadder.paddedImage);
      this.iColPsf = new ColumnManipulator(this.iPsfImage);
    ...
    PSFConvolutor.prototype.convolute = function() {
      var a, b, c, columns, d, iCol, iColM, iModelData, iPsfData, iRow, iRowM, l, ldnCol, ldnRow, modelData, modelLength, norm, paddedLength, padder, r, rCol, rColM, rModelData, rPsfData, rRow, rRowM, rows;
      rows = this.rows;
      columns = this.columns;
      ldnRow = this.ldnRow;
      ldnCol = this.ldnColumn;
