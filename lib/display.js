...
(function() {
  ...
  Display = (function(_super) {
    ...
    function Display(container, desiredWidth, image) {
      ...
      this.colormap = new Colormap(colors.heat);
    ...
    Display.prototype.processImage = function() {
      var canvasHeight, canvasView, canvasWidth, coeff, colorView, height, invertCoeff, scaleRatio, stretchView, width, x, y;
      stretchView = this.stretchView8;
      colorView = this.colorView32;
      canvasView = this.canvasView32;
      this.stretch(this.image.data, stretchView, this.min, this.max);
      console.log(this.colormap);
      this.colormap.colorize(stretchView, colorView);
