...
(function() {
  var Canvas, Display, colors, stretches, utils,
  ...
  Display = (function(_super) {
    ...
    function Display(container, desiredWidth, image) {
      ...
      this.min = utils.min(this.imageData);
      this.max = utils.max(this.imageData);
    ...
    Display.prototype.processImage = function() {
      ...
      this.stretch(this.imageData, this.stretchView8, this.min, this.max);
